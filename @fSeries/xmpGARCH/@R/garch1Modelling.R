...
#  setClass               S4: Class representation
...
# PROGRAM STRUCTURE:     FOR FUNCTION - .garchGlobal:
...
{   # A function implemented by Diethelm Wuertz   
    ...
    # Note:
    #   Although it is possible to generate as sublcasses of this 
    #   family ARCH and GARCH processes use in this case the function 
    #   garchSim.
    #   To generate the subclass of ARCH models, use GARCH(p,0).
    #   This is a Splus like function call.
