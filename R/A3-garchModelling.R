...
# METHODS:					DESCRIPTION:
#  predict.fGARCH			 Predicts from an GARCH Time Series Process 
...
#  fitted.vales.fGARCH		 Returns Fitted Values from a Fitted GARCH Object
...
# METHODS:					DESCRIPTION:
#  predict.fAPARCH			 Predicts from an APARCH Time Series Process 
...
#  fitted.vales.fAPARCH		 Returns Fitted Values from a Fitted APARCH Object
#  residuals.fAPARCH		 Returns Residuals from a Fitted APARCH Object
# ##############################################################################
